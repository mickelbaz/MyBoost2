...
foreach($membres as list ($nom)){?>
  ...
  <td><a href="#" onclick="if (confirm('Bannir ce membre ?')) window.location='index.php?page=bannir_personne&pseudo=<?php echo $nom?>'; return false"><INPUT type="button" name="bannir" value="Bannir ce membre"/></td></a>
</tr>
<?php
} ?>
</table>
